...
<script>
    ...
    export default {
        name: 'mark-down',
        props: ['mdValuesP', 'fullPageStatusP', 'editStatusP', 'previewStatusP', 'navStatusP', 'icoStatusP', 'mdValuesT'],
        data() {
            return {
                title: this.mdValuesT || '',
        ...
        methods: {
            ...
            addImage: function(evt) {
                this.$emit('uploadImg');
                // insertContent("![TEST](/static/img/4.jpg)", this);
            },
            ...
            changeValue: function() {
                ...
                data.content = marked(this.input, {
                    sanitize: true
                });
